...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-monitor-dashboard/node_modules/monitor-dashboard/lib/js/Component.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-monitor-dashboard/node_modules/monitor-dashboard/lib/js/Component.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-monitor-dashboard/node_modules/monitor-dashboard/lib/js/</a> &#187; Component.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >      UI.containedModel(t, 'viewOptions', Backbone.Model);</span>
<span class="cstat-no" title="statement not covered" >      UI.containedModel(t, 'monitor', Monitor);</span>
    },
&nbsp;
    /**
    ...
    */
    setDefaultSize: <span class="fstat-no" title="function not covered" >function(size) {</span>
<span class="cstat-no" title="statement not covered" >      var t = this,</span>
          css = _.clone(t.get('css')),
          parsedCss = $.parseStyleString(css['.nm-cv-viewport'] || '');
<span class="cstat-no" title="statement not covered" >      if (!parsedCss.height &amp;&amp; !parsedCss.width) {</span>
<span class="cstat-no" title="statement not covered" >        parsedCss.height = size.height + 'px';</span>
<span class="cstat-no" title="statement not covered" >        parsedCss.width = size.width + 'px';</span>
<span class="cstat-no" title="statement not covered" >        css['.nm-cv-viewport'] = $.makeStyleString(parsedCss);</span>
<span class="cstat-no" title="statement not covered" >        t.set({css: css});</span>
      }
    },
&nbsp;
    // Overridden to produce only the persistent portion of the page
    toJSON: <span class="fstat-no" title="function not covered" >function(options) {</span>
<span class="cstat-no" title="statement not covered" >      var t = this,</span>
...
<span class="cstat-no" title="statement not covered" >      if (opts.monitorOnly) {</span>
<span class="cstat-no" title="statement not covered" >        raw.monitor = t.get('monitor').toMonitorJSON(opts);</span>
      }
